"""
Example of a multilayer-perceptron learning XOR using tensorflow.layers
...
## hidden layer
h = tf.layers.dense(X, dim_h, activation=tf.tanh)
## output layer
model = tf.layers.dense(h, 1, activation=tf.tanh)
